...
import com.kamilh.volleyballstats.presentation.resources.ColorValues

@Suppress("MagicNumber")
object AppColor {
    val GreyDark = Color(color = 0xFF1A1D23)
    val Grey = Color(color = ColorValues.Grey)

    val White = Color.White

    val LightPrimary = Color(ColorValues.LightPrimary)
    val LightOnPrimary = Color(0xFFFFFFFF)
    val LightPrimaryContainer = Color(ColorValues.LightPrimaryContainer)
    ...
    val LightTertiary = Color(ColorValues.LightTertiary)
    val LightOnTertiary = Color(0xFFFFFFFF)
    val LightTertiaryContainer = Color(ColorValues.LightTertiaryContainer)
    ...
    val DarkPrimary = Color(ColorValues.DarkPrimary)
    val DarkOnPrimary = Color(0xFF522300)
    val DarkPrimaryContainer = Color(ColorValues.DarkPrimaryContainer)
    ...
    val DarkTertiary = Color(ColorValues.DarkTertiary)
    val DarkOnTertiary = Color(0xFF00363F)
    val DarkTertiaryContainer = Color(ColorValues.DarkTertiaryContainer)
